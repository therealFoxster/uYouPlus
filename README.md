...
- Get the latest build from [Foxster's AltSource](https://therealfoxster.github.io/altsource-viewer/view/app/?source=https://therealfoxster.github.io/altsource/apps.json&id=com.google.ios.youtube).
